...
;              
CREATE USER IF NOT EXISTS "SA" SALT 'a38a61004577a452' HASH 'b67a8d281358ffe2160e8901a8fd976af1e02c99c3a53eb4d34243a808c89305' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TIMESTAMP '2025-12-22 20:17:56.382615', TRUE, FALSE, FALSE, TRUE, FALSE, '$2a$10$w5h6qR/lGGThJmYNB0CNguai4w3ogLSSINwbdzzT5M2Ld3iDviSD.', NULL, NULL, NULL, TIMESTAMP '2025-12-22 20:17:56.38265', 'admin', 1);      
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(2, '0974c8ff-df7f-42db-9c84-ad3ce7a53aa0', 'web', TIMESTAMP '2025-12-22 20:17:56.505704', TRUE, FALSE, FALSE, FALSE, FALSE, '$2a$10$VXO31b2knYFUjHgL5.t1tuxFqKwKEvO1UbJpgFOI9Nlr9XUsepi4e', NULL, NULL, NULL, TIMESTAMP '2025-12-22 20:17:56.56972', 'STIRLING-PDF-BACKEND-API-USER', 2);           
